export default {
  ...
  apiUrlApproval_spklButtonRejectRequest:'https://portalmobile.dexagroup.com/api/spkl/approvalbuttonrejectrequest',
    ...
    //   Ini untuk dexa picture
    apiUrlDexaPicture_Request:'https://192.168.3.177/api/dexapicture/getpicture',
...
// export default {
//   apiUrl: 'https://dxportal.dexagroup.com',
...
//   // loginController -> v1.1.5
//   apiUrlLoginBitrix:'https://dxportal.dexagroup.com/api/login/v1.1.5/loginBitrix',

//   apiUrlLoginIT138:'https://dxportal.dexagroup.com/api/login/loginit138',

//   // apiUrlHome:'https://portalmobile.dexagroup.com/api/home/home',
//   // apiUrlHome:'https://eventapp.dexagroup.com/apipwa_dashboard',
//   apiUrlHome:'https://dxportal.dexagroup.com/api/all/list_news_and_promo',

//   apiUrlGueSehat:'https://dxportal.dexagroup.com/api/home/guesehat',
//   apiUrlCreateLeaveRequest:'https://dxportal.dexagroup.com/api/ees/createleaverequest',
//   apiUrlMyLeaveRequest:'https://dxportal.dexagroup.com/api/ees/myleaverequest',

//   apiUrlApprovalRequest:'https://dxportal.dexagroup.com/api/ees/approvalrequest',
//   apiUrlApprovalButtonApproveRequest:'https://dxportal.dexagroup.com/api/ees/approvalbuttonapproverequest',
//   apiUrlApprovalButtonRejectRequest:'https://dxportal.dexagroup.com/api/ees/approvalbuttonrejectrequest',

//   apiUrlMyTiket:'https://dxportal.dexagroup.com/api/it138/mytiket',
//   apiUrlMyTiketApprove:'https://dxportal.dexagroup.com/api/it138/mytiketApprove',
//   apiUrlticketSubmitRequest:'https://dxportal.dexagroup.com/api/it138/create_request',
//   apiUrlticketOpenRequest:'https://dxportal.dexagroup.com/api/it138/ticketOpenRequest',
//   apiUrlticketCloseRequest:'https://dxportal.dexagroup.com/api/it138/ticketCloseRequest',

//   apiUrlIattendHome:'https://eventapp.dexagroup.com/api',
//   apiUrlIattendAgenda:'https://eventapp.dexagroup.com/api',
//   apiUrlIattendQuestion:'https://eventapp.dexagroup.com/api',

//   apiUrlTasRequest:'https://dxportal.dexagroup.com/api/task/taskrequest',


//   // Ini untuk eTravel Approval //

//   apiUrlApproval_eTravelRequest:'https://dxportal.dexagroup.com/api/etravel/approvalrequest',
//   apiUrlApproval_eTravelButtonApproveRequest:'https://dxportal.dexagroup.com/api/etravel/approvalbuttonapproverequest',
//   apiUrlApproval_eTravelButtonRejectRequest:'https://dxportal.dexagroup.com/api/etravel/approvalbuttonrejectrequest',

//   // Ini untuk SPKL Approval //

//   apiUrlApproval_spklRequest:'https://dxportal.dexagroup.com/api/spkl/approvalrequest',
//   apiUrlApproval_spklButtonApproveRequest:'https://dxportal.dexagroup.com/api/spkl/approvalbuttonapproverequest',
//   apiUrlApproval_spklButtonRejectRequest:'https://dxportal.dexagroup.com/api/spkl/approvalbuttonrejectrequest',
